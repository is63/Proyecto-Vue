...
<template>
  <div class="container">
        ...
        <div class="card h-100 shadow-sm mb-4">
          <div class="row g-0">
            ...
            <div class="col-md-7">
              <div class="card-body">
                ...
                <p class="card-text"><small class="text-muted">{{ ruta.localidad }}</small></p>
              </div>
            </div>
          </div>
          ...
          <div class="card-footer bg-light">
            ...
            <div v-if="ruta.valoraciones.length > 0">
              <div v-for="(valoracion, idx) in ruta.valoraciones" :key="idx" class="mb-3">
    ...
    <p v-else-if="!error" class="text-center text-muted">Cargando rutas...</p>
  </div>
</template>
