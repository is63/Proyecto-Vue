  ...
  <div class="container mt-4">
    ...
    <div class="d-flex justify-content-center mb-4">
      <div class="btn-group" role="group">
        <button type="button" class="btn" :class="filtroEstado === 'todas' ? 'btn-primary' : 'btn-outline-primary'"
          @click="filtroEstado = 'todas'">
          Todas
        </button>
        <button type="button" class="btn" :class="filtroEstado === 'futuras' ? 'btn-success' : 'btn-outline-success'"
    ...
    <div v-else-if="reservasFiltradas.length === 0" class="text-center my-5">
      <p class="fs-5">No tienes reservas {{ filtroEstado !== 'todas' ? (filtroEstado === 'futuras' ? 'próximas' :
        'pasadas') : '' }}.</p>
